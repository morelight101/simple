...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26288 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26288(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26289 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26289(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26294 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26294(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26309 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26309(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26318 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26318(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26339 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26339(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26348 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26348(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26353 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26353(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26359 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26359(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26368 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26368(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26383 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26383(b);
}
});

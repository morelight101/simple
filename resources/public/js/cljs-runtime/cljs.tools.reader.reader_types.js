...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26970 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26970(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26974 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26974(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26977 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26977(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26980 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26980(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26987 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26987(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26993 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26993(reader);
}
});
...
var G__27064 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27065 = s.append(c);
c = G__27064;
s = G__27065;
continue;
}

...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__26563){
...
var vec__26567 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26567,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26567,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26567,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_26726 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_26726(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_26736 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_26736(a,b);
}
});
...
var fexpr__26669 = (function (){var G__26670 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26670__$1)].join('')));

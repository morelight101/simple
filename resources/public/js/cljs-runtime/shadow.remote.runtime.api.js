...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29101 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29101(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_29109 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_29109(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_29112 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_29112(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_29114 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_29114(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29119 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29119(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29125 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29125(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__29086,callback){
var map__29087 = p__29086;
var map__29087__$1 = cljs.core.__destructure_map(map__29087);
var input = map__29087__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29087__$1,new cljs.core.Keyword(null,"code","code",1586293142));
